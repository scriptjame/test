...
-- 🧠 Steal a Brainrot GUI phụ (final polished)
...
-- remove old gui
local old = playerGui:FindFirstChild("StealABrainrotMenu")
if old then old:Destroy() end

-- GUI
local gui=Instance.new("ScreenGui",playerGui)
gui.Name="StealABrainrotMenu"
...
title.TextSize=16
title.Text="🧠 Steal a Brainrot Scripts"
...
createBtn("Monkey Hub","https://raw.githubusercontent.com/dontasklol/Stealingurbrainrots/refs/heads/main/Kurd%20hub")

createBtn("Star Hub",nil,true,true)
createBtn("Sun Hub",nil,true,true)
