-- ⚔️ Blox Fruit GUI phụ (final polished)
...
-- remove old gui
local old = playerGui:FindFirstChild("BloxFruitMenu")
...
createBtn("Itachi Hub",nil,true,true)
createBtn("Moon Hub",nil,true,true)
...
pcall(function()
loadstring(game:HttpGet("https://pastefy.app/4MIbCUgj/raw", true))()
end)
end)
