...
local function openBladeBallMenu()
    ...
    local function createScriptBtn(text, url, color)
    ...
    createScriptBtn("AUTO PARRY Support for High Ping", "https://raw.githubusercontent.com/AgentX771/ArgonHubX/main/Loader.lua", Color3.fromRGB(0,200,255))
    createScriptBtn("AUTO PARRY + Unlock All + Explosion", "https://api.luarmor.net/files/v3/loaders/63e751ce9ac5e9bcb4e7246c9775af78.lua", Color3.fromRGB(0,255,120))
    createScriptBtn("AUTO PARRY + Spam ❤️", "https://raw.githubusercontent.com/NodeX-Enc/NodeX/refs/heads/main/Main.lua", Color3.fromRGB(255,120,120))
