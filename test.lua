...
local games = { 
    { name = "Discord", desc = "Join our Discord community!", img = "rbxassetid://80637427855653", openFn = function() openLink("https://discord.gg/your_invite") end }, 
    { name = "YouTube", desc = "Subscribe for more scripts!", img = "rbxassetid://95429734677601", openFn = function() openLink("https://youtube.com/@yourchannel") end }, 
...
-- Thông báo vàng (đặt giữa menu: dưới YouTube, trên Murder Mystery 2)
local note = Instance.new("TextLabel", hubGui) 
note.Size = UDim2.new(0.8,0,0,30) 
note.AnchorPoint = Vector2.new(0.5,0.5) 
note.Position = UDim2.new(0.5,0,0.55,0) -- căn giữa menu (chỗ giữa YouTube và MM2) 
...
-- Nút ẩn/hiện menu (trên GUI Discord)
local toggleBtn = Instance.new("TextButton", playerGui) 
toggleBtn.Size = UDim2.new(0,40,0,40) 
toggleBtn.Position = UDim2.new(0,20,0.2,0) -- ngay trên Discord 
