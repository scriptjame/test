-- 🔪 MM2 GUI phụ (Blade Ball style giữ nguyên)
...
createBtn("Vexon Hub","https://raw.githubusercontent.com/DiosDi/VexonHub/refs/heads/main/VexonHub")
createBtn("Rew Hub","https://pastefy.app/2QUPuCOb/raw")
